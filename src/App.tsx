...
import { ArrowRight, ArrowUpDown, BookOpen, CalendarDays, ChevronLeft, ChevronRight, Clipboard, Download, FileText, Filter, Grid2X2, LockKeyhole, MoreHorizontal, PanelRight, Pencil, Plus, Printer, RotateCcw, Save, Search, Settings, Share2, Sparkles, Sun, Trash2, TriangleAlert, UserRound, Users, X } from 'lucide-react'
...
const demoDecisionRows = [
  ...
  { id: 'demo-pricing', name: 'Pricing strategy', status: 'Ready to decide', step: 'Analysis', updated: 'Yesterday', templateId: 'product-launch' },
  { id: 'demo-hiring', name: 'Hiring choice', status: 'Decided', step: 'Decision', updated: '3d ago', templateId: 'hiring-choice' },
  { id: 'demo-office', name: 'Team office location', status: 'In progress', step: 'What matters', updated: '4d ago', templateId: 'project-scope' },
  { id: 'demo-redesign', name: 'Website redesign', status: 'Archived', step: 'Decision', updated: '1w ago', templateId: 'product-launch' },
]
